export default {
  ...
  config: {
    huiWebPort: "Honest-UI Web Port",
    huiWebContext: "Honest-UI Web Context",
    hysteria2TrafficTime: "Hysteria2 Traffic Time",
    huiCrtPath: "Honest-UI CRT File Path",
    huiKeyPath: "Honest-UI KEY File Path",
  ...
  hysteria: {
    ...
    config: {
      ...
      listen:
        "When the IP address is omitted, the server will listen on all interfaces, both IPv4 and IPv6. To listen on IPv4 only, you can use 0.0.0.0:443. To listen on IPv6 only, you can use [::]:443. Hysteria >= 2.8.0, supports port hopping.",
      tlsType: "TLS type",
      tls: {
